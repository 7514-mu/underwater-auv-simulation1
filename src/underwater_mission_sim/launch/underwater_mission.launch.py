...
def generate_launch_description():
    ...
    mission_dir = get_package_share_directory('underwater_mission_sim')
    comm_dir = get_package_share_directory('underwater_comm_sim')
    uuv_desc_dir = get_package_share_directory('uuv_descriptions')

    mission_yaml = os.path.join(mission_dir, 'config', 'underwater_simulation_params.yaml')
    ...
    mission_nodes = TimerAction(
        ...
        actions=[
            ...
            Node(
                package='underwater_mission_sim',
